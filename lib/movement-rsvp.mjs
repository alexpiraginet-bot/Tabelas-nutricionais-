...
export function validateRsvpPayload(input) {
  ...
  const childAgeProvided = body.childAge !== undefined && body.childAge !== null && String(body.childAge).trim() !== "";
  const childAge = childAgeProvided && Number.isInteger(Number(body.childAge)) ? Number(body.childAge) : null;

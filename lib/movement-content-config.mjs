...
export const ALLOWED_MOVEMENT_SCENES = Object.freeze({
  influencer: Object.freeze(["INF-HERO", ...Array.from({ length: 14 }, (_, index) => `INF-${String(index + 1).padStart(2, "0")}`)]),
  partner: Object.freeze(["PAR-HERO", ...Array.from({ length: 16 }, (_, index) => `PAR-${String(index + 1).padStart(2, "0")}`)]),
});
...
const ALLOWED_OVERRIDE_FIELDS = new Set(["imageUrl", "mobileImageUrl", "imageOpacity", "eyebrow", "title", "body", "altText"]);

(function () {
  ...
  var baseScenes = {
    ...
    "PAR-08": ["Cocriação", "Um produto pode nascer da conversa — se a técnica permitir.", "O estudo de picolé ou rótulo co-branded considera formulação, rotulagem, alergênicos, produção e aprovação.", "Seis picolés Bentôlé do catálogo vigente compostos em painel editorial para estudo de cocriação responsável"],

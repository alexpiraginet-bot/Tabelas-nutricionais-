...
export const PRODUCTS = [
  ...
  { id:"chocolate-dubai", name:"Chocolate Dubai", category:"gelato", sub:"Cacau · pistache · kadaif", emoji:"✨",
    ...
    serving:60, portionLabel:"60 g",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Leite Piracanjuba",qty:"350 g"},{name:"Whey WPH",qty:"420 g"},{name:"Cacau em pó",qty:"250 g"},{name:"Creme de Pistache G",qty:"200 g"},{name:"Chocolate 70% Zero (Lukau)",qty:"100 g"},{name:"Kadaif",qty:"50 g"}],
  ...
  { id:"morango", name:"Morango", category:"gelato", sub:"Cremoso de fruta", emoji:"🍓", estimated:true,
    ...
    serving:60, portionLabel:"60 g",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Polpa de morango",qty:"600 g"},{name:"Whey WPH",qty:"320 g"},{name:"Leite Piracanjuba",qty:"300 g"}],
  ...
  { id:"baunilha", name:"Baunilha de Madagascar", category:"gelato", sub:"Fior di latte · fava de baunilha", emoji:"🤍", estimated:true,
    ...
    serving:60, portionLabel:"60 g",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Leite Piracanjuba",qty:"350 g"},{name:"Whey WPH",qty:"350 g"},{name:"Fava de baunilha Madagascar",qty:"6 g"}],
  ...
  { id:"avela", name:"Avelã", category:"gelato", sub:"Nocciola · pasta de avelã", emoji:"🌰", estimated:true,
    ...
    serving:60, portionLabel:"60 g",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Leite Piracanjuba",qty:"350 g"},{name:"Whey WPH",qty:"400 g"},{name:"Pasta de avelã",qty:"200 g"}],
  ...
  { id:"cafe", name:"Café Espresso", category:"gelato", sub:"Espresso italiano", emoji:"☕", estimated:true,
    ...
    serving:60, portionLabel:"60 g",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Leite Piracanjuba",qty:"350 g"},{name:"Whey WPH",qty:"380 g"},{name:"Café espresso",qty:"180 mL"}],
  ...
  { id:"menta", name:"Menta Intensa", category:"gelato", sub:"Menta · cacau 70%", emoji:"🌿", estimated:true,
    ...
    serving:60, portionLabel:"60 g",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Leite Piracanjuba",qty:"350 g"},{name:"Whey WPH",qty:"350 g"},{name:"Extrato natural de menta",qty:"8 g"},{name:"Chocolate 70% Zero (Lukau)",qty:"80 g"}],
  ...
  { id:"banana-canela", name:"Banana com Canela", category:"gelato", sub:"Banana · canela do Ceilão", emoji:"🍌", estimated:true,
    ...
    serving:60, portionLabel:"60 g",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Banana",qty:"500 g"},{name:"Whey WPH",qty:"300 g"},{name:"Leite Piracanjuba",qty:"300 g"},{name:"Canela do Ceilão",qty:"5 g"}],
  ...
  { id:"bentole-choco-dubai", name:"Chocolate Dubai", category:"bentole", sub:"Cacau · pistache · kadaif · stracciatella", emoji:"✨",
    ...
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Whey WPH",qty:"600 g"},{name:"Leite em pó",qty:"350 g"},{name:"Cacau em pó",qty:"300 g"},{name:"Creme de Pistache G",qty:"300 g"},{name:"Stracciatella Zero (Lukau)",qty:"150 g"},{name:"Kadaif",qty:"70 g"}],
  ...
  { id:"bentole-franui", name:"Franui", category:"bentole", sub:"Framboesa · choco branco · choco 70%", emoji:"🫐",
    ...
    serving:55, portionLabel:"55 g (mini picolé)",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Framboesa",qty:"2.000 g"},{name:"Colágeno Hidrolisado",qty:"80 g"},{name:"Chocolate Branco Zero (Lukau)",qty:"30 g"},{name:"Chocolate 70% Zero (Lukau)",qty:"15 g"}],
  ...
  { id:"bentole-pistache-cb", name:"Pistache & Choco Branco", category:"bentole", sub:"Recheio + cobertura + pistaches inteiros", emoji:"💚",
    ...
    serving:60, portionLabel:"60 g (mini picolé)",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Leite desnatado",qty:"350 g"},{name:"Whey WPH",qty:"680 g"},{name:"Pasta Pistache Selection",qty:"170 g"},{name:"Latissimo",qty:"200 g"},{name:"Chocolate Branco Zero (Lukau)",qty:"30 g"}],
  ...
  { id:"bentole-prestigio", name:"Prestígio", category:"bentole", sub:"Coco cremoso · cobertura de chocolate", emoji:"🥥", estimated:true,
    ...
    serving:55, portionLabel:"55 g (mini picolé)",
    ingredients:[{name:BASE_NOME,qty:"1.000 g",note:BASE},{name:"Água",qty:"2.500 mL"},{name:"Whey WPH",qty:"650 g"},{name:"Leite Piracanjuba",qty:"350 g"},{name:"Leite de coco em pó",qty:"280 g"},{name:"Chocolate ao Leite Zero (Lukau)",qty:"120 g"},{name:"Coco ralado",qty:"60 g"}],

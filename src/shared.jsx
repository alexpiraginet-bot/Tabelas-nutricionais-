...
// próxima) e banner de horários leem daqui. Os dados mudaram de endereço: agora
// vivem em ./lojas.js, que NÃO tem JSX e por isso pode ser importado também por
// script Node — é assim que o painel admin recebe o horário sem ninguém copiar
// à mão (scripts/generate-painel-padroes.mjs). Aqui fica só o reexport, para

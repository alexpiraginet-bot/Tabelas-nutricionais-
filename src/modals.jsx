...
/* O seletor de loja saiu daqui de novo — e desta vez com o motivo registrado,
   para não voltar por engano: a tela de pedido (/pedir) já pergunta a loja E se
   é entrega ou retirada. Perguntar antes fazia o cliente responder duas vezes.
   Só faz sentido trazer de volta se substituir aquela pergunta, nunca somar. */

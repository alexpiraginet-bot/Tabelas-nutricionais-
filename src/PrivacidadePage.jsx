  ...
  return(
    <div style={{minHeight:"100vh",background:"#EAE3CE",padding:"28px 14px",fontFamily:"'DM Sans',system-ui,sans-serif"}}>
      <div style={wrap}>
        ...
        <p style={p}>Tratamos apenas os dados que você nos fornece voluntariamente nos formulários do site: <strong>nome, WhatsApp, e-mail e cidade</strong>; e, para a contratação de eventos, <strong>CPF ou CNPJ</strong> (necessário para o contrato). No <strong>Bentô em Movimento</strong>, tratamos a resposta ao convite, modalidade de participação, tamanho usado como referência para camiseta e roupa de treino da convidada, presença de marido ou mãe, presença, idade e tamanho aproximado da criança, interesse em transporte, versão da política aceita e consentimento opcional de uso de imagem. Para interessados em parceria, tratamos nome da empresa, responsável, e-mail, telefone, cota de interesse, tipo de contribuição e detalhes opcionais da proposta.</p>

  ...
  return(
    <div style={{minHeight:"100vh",background:"#EAE3CE",padding:"28px 14px",fontFamily:"'DM Sans',system-ui,sans-serif"}}>
      <div style={wrap}>
        ...
        <p style={p}>Também usamos serviços de terceiros para operar o site e guardar esses dados: <strong>Vercel</strong> (hospedagem), <strong>Upstash</strong> (banco de dados) e <strong>Supabase</strong> (armazenamento de arquivos). Guardamos os dados de contrato pelo prazo legal de guarda de documentos fiscais e contratuais. Para pedir acesso, correção ou exclusão dos seus dados, escreva para bentogelateria@gmail.com.</p>

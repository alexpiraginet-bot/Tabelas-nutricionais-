  ...
  return(
    <div style={{minHeight:"100vh",background:"#EAE3CE",padding:"28px 14px",fontFamily:"'DM Sans',system-ui,sans-serif"}}>
      <div style={wrap}>
        ...
        <p style={p}>Tratamos apenas os dados que você nos fornece voluntariamente nos formulários do site: <strong>nome, WhatsApp, e-mail e cidade</strong>; e, para a contratação de eventos, <strong>CPF ou CNPJ</strong> (necessário para o contrato). No <strong>Bentô em Movimento</strong>, tratamos a resposta ao convite, modalidade de participação, tamanhos de camiseta e roupa de treino da influenciadora, presença de marido ou mãe, presença de criança e tamanho aproximado para eventual kit, versão da política aceita e consentimento opcional de uso de imagem. Para interessados em parceria, tratamos nome da empresa, responsável, e-mail, telefone, cota de interesse e tipo de contribuição.</p>
        <p style={p}>Não solicitamos nome, documento, idade exata ou dados de saúde da criança. A informação infantil é limitada à presença e ao tamanho aproximado necessário para planejar a oficina e um eventual kit.</p>
